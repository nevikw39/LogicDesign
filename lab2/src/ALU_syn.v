...
module ALU ( A, B, Cin, Mode, Y, Cout, Overflow );
  ...
  wire   cout_a, cout_s, n194, n195, n196, n197, n198, n199, n200, n201, n202,
  ...
  Adder16bit_0 adder ( .A(A), .B({B[15:1], b[0]}), .Cin(Cin), .S(sa), .Cout(
        cout_a) );
  Adder16bit_1 suber ( .A(A), .B(b), .Cin(1'b0), .S(ss), .Cout(cout_s) );
  ...
  XNOR2X1 U217 ( .A(n194), .B(B[9]), .Y(b[9]) );
  XNOR2X1 U218 ( .A(n195), .B(n196), .Y(b[8]) );
  NAND2X1 U219 ( .A(n197), .B(n198), .Y(n195) );
  XNOR2X1 U220 ( .A(n197), .B(B[7]), .Y(b[7]) );
  XNOR2X1 U221 ( .A(n199), .B(n200), .Y(b[6]) );
  NAND2X1 U222 ( .A(n201), .B(n202), .Y(n199) );
  XNOR2X1 U223 ( .A(n201), .B(B[5]), .Y(b[5]) );
  XNOR2X1 U224 ( .A(n203), .B(n204), .Y(b[4]) );
  NAND2X1 U225 ( .A(n205), .B(n206), .Y(n203) );
  XNOR2X1 U226 ( .A(n205), .B(B[3]), .Y(b[3]) );
  XNOR2X1 U227 ( .A(B[2]), .B(n207), .Y(b[2]) );
  NOR2X1 U228 ( .A(B[1]), .B(b[0]), .Y(n207) );
  XNOR2X1 U229 ( .A(n208), .B(B[1]), .Y(b[1]) );
  XNOR2X1 U230 ( .A(n209), .B(n210), .Y(b[15]) );
  NAND2X1 U231 ( .A(n211), .B(n212), .Y(n209) );
  XNOR2X1 U232 ( .A(n211), .B(B[14]), .Y(b[14]) );
  NOR2BX1 U233 ( .AN(n213), .B(B[13]), .Y(n211) );
  XNOR2X1 U234 ( .A(n213), .B(B[13]), .Y(b[13]) );
  NOR3X1 U235 ( .A(B[11]), .B(B[12]), .C(n214), .Y(n213) );
  XOR2X1 U236 ( .A(n215), .B(B[12]), .Y(b[12]) );
  OR2X1 U237 ( .A(n214), .B(B[11]), .Y(n215) );
  XOR2X1 U238 ( .A(n214), .B(B[11]), .Y(b[11]) );
  NAND3X1 U239 ( .A(n216), .B(n217), .C(n194), .Y(n214) );
  XNOR2X1 U240 ( .A(n218), .B(n216), .Y(b[10]) );
  ...
  AOI211X1 U388 ( .A0(b[0]), .A1(n396), .B0(n397), .C0(n398), .Y(n395) );
  ...
  NOR3X1 U412 ( .A(B[2]), .B(b[0]), .C(B[1]), .Y(n205) );
  ...
  OAI211X1 U462 ( .A0(b[0]), .A1(n234), .B0(n305), .C0(n328), .Y(n436) );
  ...
  OAI21XL U473 ( .A0(b[0]), .A1(n233), .B0(n392), .Y(n435) );
